...
extern "C"
{
   ...
   */
  _DLEXPORT int G2Diagnostic_init_V2(const char *moduleName, const char *iniParams, const int verboseLogging);
  _DLEXPORT int G2Diagnostic_initWithConfigID_V2(const char *moduleName, const char *iniParams, const long long initConfigID, const int verboseLogging);
   ...
   */
  _DLEXPORT int G2Diagnostic_reinit_V2(const long long initConfigID);
  ...
  _DLEXPORT EntityListBySizeHandle G2Diagnostic_getEntityListBySize(const size_t entitySize);
  _DLEXPORT char* G2Diagnostic_fetchNextEntityBySize(EntityListBySizeHandle entityListBySizeHandle, char *responseBuf, const size_t bufSize);
  _DLEXPORT void G2Diagnostic_closeEntityListBySize(EntityListBySizeHandle entityListBySizeHandle);
  _DLEXPORT int G2Diagnostic_getEntityListBySize_V2(const size_t entitySize,EntityListBySizeHandle* entityListBySizeHandle);
  _DLEXPORT int G2Diagnostic_fetchNextEntityBySize_V2(EntityListBySizeHandle entityListBySizeHandle, char *responseBuf, const size_t bufSize);
  _DLEXPORT int G2Diagnostic_closeEntityListBySize_V2(EntityListBySizeHandle entityListBySizeHandle);
