...
extern "C"
{
   ...
   */
  _DLEXPORT int G2Hasher_init_V2(const char *moduleName, const char *iniParams, const int verboseLogging);
  _DLEXPORT int G2Hasher_initWithConfig_V2(const char *moduleName, const char *iniParams, const char *configJson, const int verboseLogging);
   ...
   */
  _DLEXPORT int G2Hasher_destroy();
   ...
   */
  _DLEXPORT int G2Hasher_process(const char *record, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
   ...
   *        enough.
   */
  _DLEXPORT int G2Hasher_exportTokenLibrary(char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
   ...
   */
  _DLEXPORT int G2Hasher_getLastException(char *buffer, const size_t bufSize);
   ...
   * @return number of bytes copied into buffer
   */
  _DLEXPORT int G2Hasher_getLastExceptionCode();
