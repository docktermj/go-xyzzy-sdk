/**********************************************************************************
 © Copyright Senzing, Inc. 2019-2020
...
extern "C"
{
   ...
   */
  _DLEXPORT int G2ConfigMgr_init_V2(const char *moduleName, const char *iniParams, const int verboseLogging);
   ...
   */
  _DLEXPORT int G2ConfigMgr_destroy();
   ...
   */
  _DLEXPORT int G2ConfigMgr_getLastException(char *buffer, const size_t bufSize);
   ...
   * @return number of bytes copied into buffer
   */
  _DLEXPORT int G2ConfigMgr_getLastExceptionCode();
