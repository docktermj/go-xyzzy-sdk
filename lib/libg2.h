...
extern "C"
{
  ...
  #define G2_EXPORT_INCLUDE_RESOLVED static_cast<int>( 1 << 0 )  // we should include entities with "resolved" relationships
  #define G2_EXPORT_INCLUDE_POSSIBLY_SAME static_cast<int>( 1 << 1 )  // we should include entities with "possibly same" relationships
  #define G2_EXPORT_INCLUDE_POSSIBLY_RELATED static_cast<int>( 1 << 2 )  // we should include entities with "possibly related" relationships
  #define G2_EXPORT_INCLUDE_NAME_ONLY static_cast<int>( 1 << 3 )  // we should include entities with "name only" relationships
  #define G2_EXPORT_INCLUDE_DISCLOSED static_cast<int>( 1 << 4 )  // we should include entities with "disclosed" relationships
  #define G2_EXPORT_INCLUDE_SINGLETONS static_cast<int>( 1 << 5 )  // we should include singleton entities
  ...
  #define G2_ENTITY_INCLUDE_POSSIBLY_SAME_RELATIONS static_cast<int>( 1 << 6 )  // include "possibly same" relationships on entities
  #define G2_ENTITY_INCLUDE_POSSIBLY_RELATED_RELATIONS static_cast<int>( 1 << 7 )  // include "possibly related" relationships on entities
  #define G2_ENTITY_INCLUDE_NAME_ONLY_RELATIONS static_cast<int>( 1 << 8 )  // include "name only" relationships on entities
  #define G2_ENTITY_INCLUDE_DISCLOSED_RELATIONS static_cast<int>( 1 << 9 )  // include "disclosed" relationships on entities
  ...
  #define G2_ENTITY_INCLUDE_ALL_FEATURES static_cast<int>( 1 << 10 )  // include all features for entities
  #define G2_ENTITY_INCLUDE_REPRESENTATIVE_FEATURES static_cast<int>( 1 << 11 )  // include only representative features on entities

  /* flags for getting extra information about an entity  */
  #define G2_ENTITY_INCLUDE_ENTITY_NAME static_cast<int>( 1 << 12 )  // include the name of the entity
  #define G2_ENTITY_INCLUDE_RECORD_SUMMARY static_cast<int>( 1 << 13 )  // include the record summary of the entity
  #define G2_ENTITY_INCLUDE_RECORD_DATA static_cast<int>( 1 << 14 )  // include the basic record data for the entity
  #define G2_ENTITY_INCLUDE_RECORD_MATCHING_INFO static_cast<int>( 1 << 15 )  // include the record matching info for the entity
  #define G2_ENTITY_INCLUDE_RECORD_JSON_DATA static_cast<int>( 1 << 16 )  // include the record json data for the entity
  #define G2_ENTITY_INCLUDE_RECORD_FORMATTED_DATA static_cast<int>( 1 << 17 )  // include the record formattted data for the entity
  #define G2_ENTITY_INCLUDE_RECORD_FEATURE_IDS static_cast<int>( 1 << 18 )  // include the features identifiers for the records
  #define G2_ENTITY_INCLUDE_RELATED_ENTITY_NAME static_cast<int>( 1 << 19 )  // include the name of the related entities
  #define G2_ENTITY_INCLUDE_RELATED_MATCHING_INFO static_cast<int>( 1 << 20 )  // include the record matching info of the related entities
  #define G2_ENTITY_INCLUDE_RELATED_RECORD_SUMMARY static_cast<int>( 1 << 21 )  // include the record summary of the related entities
  #define G2_ENTITY_INCLUDE_RELATED_RECORD_DATA static_cast<int>( 1 << 22 )  // include the basic record of the related entities

  /* flag for extra feature data  */
  #define G2_ENTITY_OPTION_INCLUDE_INTERNAL_FEATURES static_cast<int>( 1 << 23 )  // include internal features
  #define G2_ENTITY_OPTION_INCLUDE_FEATURE_STATS static_cast<int>( 1 << 24 )  // include statistics on features

  /* flags for finding entity path data  */
  #define G2_FIND_PATH_PREFER_EXCLUDE static_cast<int>( 1 << 25 )  // excluded entities are still allowed, but not preferred

  /* flag for including search result feature scores  */
  #define G2_SEARCH_INCLUDE_FEATURE_SCORES static_cast<int>( 1 << 26 )  // include feature scores from search results
  #define G2_SEARCH_INCLUDE_STATS static_cast<int>( 1 << 27 )  // include statistics from search results
  ...
  #define G2_WHY_ENTITY_DEFAULT_FLAGS (G2_ENTITY_DEFAULT_FLAGS | G2_ENTITY_INCLUDE_RECORD_FEATURE_IDS | G2_ENTITY_OPTION_INCLUDE_INTERNAL_FEATURES | G2_ENTITY_OPTION_INCLUDE_FEATURE_STATS) // the recommended default flag values for why-analysis on entities
   ...
   */
  _DLEXPORT int G2_init_V2(const char *moduleName, const char *iniParams, const int verboseLogging);
  _DLEXPORT int G2_initWithConfigID_V2(const char *moduleName, const char *iniParams, const long long initConfigID, const int verboseLogging);
   ...
   */
  _DLEXPORT int G2_reinit_V2(const long long initConfigID);
  ...
  _DLEXPORT int G2_processWithInfo(const char *record, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
  ...
  _DLEXPORT int G2_processRedoRecordWithInfo(const int flags, char **responseBuf, size_t *bufSize, char **infoBuf, size_t *infoBufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
  ...
  _DLEXPORT int G2_addRecordWithInfo(const char* dataSourceCode, const char* recordID, const char* jsonData, const char *loadID, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
  _DLEXPORT int G2_addRecordWithInfoWithReturnedRecordID(const char* dataSourceCode, const char* jsonData, const char *loadID, const int flags, char *recordIDBuf, const size_t recordIDBufSize, char **responseBuf, size_t *responseBufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
  _DLEXPORT int G2_replaceRecord(const char* dataSourceCode, const char* recordID, const char* jsonData, const char *loadID);
  _DLEXPORT int G2_replaceRecordWithInfo(const char* dataSourceCode, const char* recordID, const char* jsonData, const char *loadID, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));


  /**
   * @brief Reevaluate an entity in the database.
   */
  _DLEXPORT int G2_reevaluateRecord(const char* dataSourceCode, const char* recordID, const int flags);
  _DLEXPORT int G2_reevaluateEntity(const long long entityID, const int flags);
  _DLEXPORT int G2_reevaluateRecordWithInfo(const char* dataSourceCode, const char* recordID, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
  _DLEXPORT int G2_reevaluateEntityWithInfo(const long long entityID, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
  ...
  _DLEXPORT int G2_deleteRecordWithInfo(const char* dataSourceCode, const char* recordID, const char* loadID, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
  ...
  _DLEXPORT int G2_searchByAttributes_V2(const char* jsonData, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
  ...
  _DLEXPORT int G2_getEntityByRecordID_V2(const char* dataSourceCode, const char* recordID, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
  ...
  _DLEXPORT int G2_getRecord_V2(const char* dataSourceCode, const char* recordID, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
  ...
  _DLEXPORT int G2_findPathByEntityID_V2(const long long entityID1, const long long entityID2, const int maxDegree, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
  ...
  _DLEXPORT int G2_findPathByRecordID_V2(const char* dataSourceCode1, const char* recordID1, const char* dataSourceCode2, const char* recordID2, const int maxDegree, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
   ...
   *         an exception was thrown and caught.
   */
  _DLEXPORT int G2_findPathExcludingByEntityID(const long long entityID1, const long long entityID2, const int maxDegree, const char* excludedEntities, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
  _DLEXPORT int G2_findPathExcludingByRecordID(const char* dataSourceCode1, const char* recordID1, const char* dataSourceCode2, const char* recordID2, const int maxDegree, const char* excludedRecords, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
   ...
   *         an exception was thrown and caught.
   */
  _DLEXPORT int G2_findPathIncludingSourceByEntityID(const long long entityID1, const long long entityID2, const int maxDegree, const char* excludedEntities, const char* requiredDsrcs, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
  _DLEXPORT int G2_findPathIncludingSourceByRecordID(const char* dataSourceCode1, const char* recordID1, const char* dataSourceCode2, const char* recordID2, const int maxDegree, const char* excludedRecords, const char* requiredDsrcs, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
  ...
  _DLEXPORT int G2_findNetworkByEntityID_V2(const char* entityList, const int maxDegree, const int buildOutDegree, const int maxEntities, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
  ...
  _DLEXPORT int G2_findNetworkByRecordID_V2(const char* recordList, const int maxDegree, const int buildOutDegree, const int maxEntities, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
  ...
  _DLEXPORT int G2_whyEntityByRecordID_V2(const char* dataSourceCode, const char* recordID, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
  ...
  _DLEXPORT int G2_whyEntityByEntityID_V2(const long long entityID, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
  ...
  _DLEXPORT int G2_whyRecords_V2(const char* dataSourceCode1, const char* recordID1, const char* dataSourceCode2, const char* recordID2, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
  ...
  _DLEXPORT int G2_whyEntities_V2(const long long entityID1, const long long entityID2, const int flags, char **responseBuf, size_t *bufSize, void *(*resizeFunc)(void *ptr, size_t newSize));
   ...
   */
  _DLEXPORT ExportHandle G2_exportJSONEntityReport(const int flags);
  _DLEXPORT int G2_exportJSONEntityReport_V3(const int flags, ExportHandle* responseHandle);
   ...
   * @return Returns an export handle that the entity data can be read from.
   */
  _DLEXPORT ExportHandle G2_exportCSVEntityReport_V2(const char* csvColumnList, const int flags);
  _DLEXPORT int G2_exportCSVEntityReport_V3(const char* csvColumnList, const int flags, ExportHandle* responseHandle);
   ...
   */
  _DLEXPORT char* G2_fetchNext(ExportHandle responseHandle, char *responseBuf, const size_t bufSize);
  _DLEXPORT int G2_fetchNext_V3(ExportHandle responseHandle, char *responseBuf, const size_t bufSize);
   ...
   */
  _DLEXPORT void G2_closeExport(ExportHandle responseHandle);
  _DLEXPORT int G2_closeExport_V3(ExportHandle responseHandle);
