...
extern "C" 
{
  ...
  typedef int ScoreSimpleFunc(const char *ftypeCode, const char *felemCode, const char *inboundStr, const int inboundIsHashed, const char *candidateStr, const int candidateIsHashed, char *behavior, const size_t maxBehaviorBufferSize, int* resultScore, char *errorStr, const size_t maxErrorStrSize);
